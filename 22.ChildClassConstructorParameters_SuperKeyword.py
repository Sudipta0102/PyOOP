...
# parent class cannot access child class variables. 
#item1 = Item("PhoneName", 100, 2, True)
# naturally you can do everything you did with Item class.
phone1 = Phone("PhoneName", 100, 2, True)
print(phone1.all) # notice that this all list only has parent class attributes,
                  # it doesn't include child class attributes. That's because 
                  # __repr__ magic method is only for the parent class.   
